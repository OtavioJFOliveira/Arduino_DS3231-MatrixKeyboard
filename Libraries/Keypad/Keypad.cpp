...
//////////////////////////////////////////////////////////////////////////////
int Keypad::getKey_int() {
	single_key = true;

	if (getKeys() && key[0].stateChanged && (key[0].kstate==PRESSED))
		
		 
		return (int) key[0].kchar -48;   // alteração de codigo realizada por Otavio Oliveira
                                          // função para retorno dos numeros de um teclado matricial
	                                      // no modo inteiro, realizando converção do modo char 
    single_key = false;
